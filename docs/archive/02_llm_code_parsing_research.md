> Archived 2026-08-29 from `docs/plan/02_llm_code_parsing_research.md`.
> Superseded by: `docs/plan/12_code_generation_improvements.md and docs/plan/17_code_simplification.md (parsing approach implemented)`.
