...
|---------|--------|--------|
| `2026-09-22-post-ci-recovery-followups.md` | Post-recovery hardening — caafe/llmfe/malmas typed failure records, sandbox sentinel non-stringification + preload comment, limits default alignment, security runbook + branch-protection checklist | Complete 2026-09-22 |
