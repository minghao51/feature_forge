...
class TestArtifactConfig:
    ...
    def test_disk_mode_creates_dir(self, tmp_dir: str) -> None:
...
class TestLazyDataFrameRef:
    def test_parquet_roundtrip(self, sample_df: pd.DataFrame, tmp_dir: str) -> None:
    ...
    def test_csv_roundtrip(self, sample_df: pd.DataFrame, tmp_dir: str) -> None:
    ...
    def test_feather_roundtrip(self, sample_df: pd.DataFrame, tmp_dir: str) -> None:
    ...
    def test_invalid_format_raises(self, tmp_dir: str) -> None:
    ...
    def test_invalidate(self, sample_df: pd.DataFrame, tmp_dir: str) -> None:
        path = os.path.join(tmp_dir, "test.parquet")
        sample_df.to_parquet(path)
        ref = LazyDataFrameRef(path, "parquet")
        _ = ref.load()
...
class TestDataFrameStorage:
    ...
    def test_hybrid_mode_small_stays_memory(self, sample_df: pd.DataFrame, tmp_dir: str) -> None:
        cfg = ArtifactConfig(
            storage_mode="hybrid",
            storage_dir=tmp_dir,
    ...
    def test_hybrid_mode_large_spills_to_disk(self, tmp_dir: str) -> None:
    ...
    def test_disk_csv_format(self, sample_df: pd.DataFrame, tmp_dir: str) -> None:
    ...
    def test_disk_feather_format(self, sample_df: pd.DataFrame, tmp_dir: str) -> None:
