...
try:
    from hamilton.function_modifiers import cache as _hamilton_cache  # type: ignore[import-untyped]
    ...
    def cache(**_: str) -> Callable[[T], T]:
        """Return a no-op cache decorator without Hamilton installed."""
    ...
    def cache(**kwargs: str) -> Callable[[T], T]:
        """Apply Hamilton cache behavior metadata."""
        return cast(Callable[[T], T], _hamilton_cache(**kwargs))
